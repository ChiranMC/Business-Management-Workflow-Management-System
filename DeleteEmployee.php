...
<html lang="en">
    <head>
        ...
        <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
         ...
         <!--===== CSS ===== -->
        <link rel="stylesheet" href="DeleteEmployee-assets/css/mainpagestyles.css">
    ...
    <body id="body-pd">
            ...
            <div class="container">
                ...
                <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $sqle = "CALL DeletedEmployeeHistory('$id')";
                ...
                <form method="post" action="">
                    ...
                    <br>
                    <br>
                    <input type="submit" value="Delete" class="loging_BTN">
                    <br>
                    <br>
                </form>
                </div>  
        ...
        <!-- ===== MAIN JS =====-->
        <script src="DeleteEmployee-assets/js/mainpagej.js"></script>
    </body>
</html>