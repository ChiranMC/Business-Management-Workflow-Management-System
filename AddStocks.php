            ...
            <div class="container">
                ...
                <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $sql = "INSERT INTO stock (ID, Category, Item_name, Material, Quantity, Sizes, Price) VALUES ('$id', '$category', '$item_name', '$material', $quantity, '$sizes', $price)";
                ...
                <form method="post" action="">
                    ...
                    <br>
                    <br>
                    <input type="submit" value="Add" class="loging_BTN">
                    <br>
                    <br>
                </form>
                </div>  
