...
<html lang="en">
    <head>
        ...
        <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
         ...
         <!--===== CSS ===== -->
        <link rel="stylesheet" href="Monthly-assets/css/mainpagestyles.css">
    ...
    <body id="body-pd">
        ...
        <center>
            <div class="container">
                ...
                <label class="mnthlsls_lbl">Search Monthly Sales Detials :</label>
                <br>
                    ...
                    <select name="branch" required>
                        ...
                        <option value="One Galle Face">OGF</option>
            ...
            <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        if (isset($_GET['delete_id'])) {
                            ...
                            $sql = "DELETE FROM monthly_sales WHERE ID = $delete_id";
                        ...
                        $sql = "SELECT * FROM monthly_sales WHERE Month = '$monthS' AND Branch_name = '$branchS'";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo "<div class='dailySales box-Shadow-2'>";
                            echo "<table class='styled-table'>";
                            echo "<tr><th>ID</th><th>Branch</th><th>Profit</th><th>Month</th><th>Delete</th></tr>";
                        ...
                        if ($result->num_rows > 0) {
                            echo "<div class='dailySales box-Shadow-2'>";
                            echo "<table class='styled-table'>";
                            echo "<tr><th>ID</th><th>Branch</th><th>Profit</th><th>Month</th><th>Year</th><th>Delete</th></tr>";
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . $row['ID'] . "</td>";
                                echo "<td>" . $row['Branch_name'] . "</td>";
        ...
        <!-- ===== MAIN JS =====-->
        <script src="Monthly-assets/js/mainpagej.js"></script>
    </body>
</html>