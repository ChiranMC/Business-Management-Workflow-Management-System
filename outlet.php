...
<html lang="en">
    <head>
        ...
        <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
         ...
         <!--===== CSS ===== -->
        <link rel="stylesheet" href="Outlet-assets/css/mainpagestyles.css">
    ...
    <body id="body-pd">
        ...
        <center>
            ...
            <div class="orders box-Shadow-1">
                ...
                <label class="out_lbl">Search outlet Sales Detials :</label>
                <br>
            ...
            <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        if (isset($_GET['delete_id'])) {
                            ...
                            $sql = "DELETE FROM daily_sales WHERE ID = $delete_id";
                        ...
                        $sql = "SELECT * FROM daily_sales WHERE Date = '$dateS' AND Branch = '$branchS'";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo "<div class='dailySales box-Shadow-2'>";
                            echo "<table class='styled-table'>";
                            echo "<tr><th>ID</th><th>Branch</th><th>Profit</th><th>Date</th><th>Delete</th></tr>";
        ...
        <!-- ===== MAIN JS =====-->
        <script src="Outlet-assets/js/mainpagej.js"></script>
    </body>
</html>