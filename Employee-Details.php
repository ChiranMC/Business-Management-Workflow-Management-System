...
<html lang="en">
    <head>
        ...
        <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
         ...
         <!--===== CSS ===== -->
        <link rel="stylesheet" href="EmployeeDetails-assets/css/mainpagestyles.css">
    ...
    <body id="body-pd">
        ...
        <br>
            ...
            <center>
                ...
                <label class="emp_lbl">Search Employee Detials by Employee ID :</label>
            ...
            <?php
                    ...
                    if($_SERVER["REQUEST_METHOD"] == "POST"){
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Age</th><th>Gender</th><th>Birth Date</th><th>NIC</th><th>Branch</th><th>Position</th><th>Salary</th></tr>";
        ...
        <!-- ===== MAIN JS =====-->
        <script src="EmployeeDetails-assets/js/mainpagej.js"></script>
    </body>
</html>