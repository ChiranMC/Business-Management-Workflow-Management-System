...
<html lang="en">
    <head>
        ...
        <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
         ...
         <!--===== CSS ===== -->
        <link rel="stylesheet" href="AddEmployee-assets/css/mainpagestyles.css">
    ...
    <body id="body-pd">
            ...
            <div class="container">
                ...
                <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $sql = "INSERT INTO employee (ID, Firstname, Lastname, Age, Gender, Birthdate, NIC, Branch, Position, Salary) VALUES ('$id', '$firstname', '$lastname', $age, '$gender', '$birthdate', '$nic', '$branch', '$position', $salary)";
                ...
                <form method="post" action="">
                    ...
                    <br>
                    <br>
                    <input type="submit" value="Register" class="loging_BTN">
                    <br>
                    <br>
                </form>
                </div>  
        ...
        <!-- ===== MAIN JS =====-->
        <script src="AddEmployee-assets/js/mainpagej.js"></script>
    </body>
</html>